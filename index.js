...
function findMinMax([firstElement, ...restElements]) {
  ...
  for (let index = 0; index < restElements.length; index++) {
    if (restElements[index] < min) {
      min = restElements[index];
    }
    if (restElements[index] > max) {
      max = restElements[index];
    }
  }
  console.log(min, max);
